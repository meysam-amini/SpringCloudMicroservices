...
//    static {
//        mockServerContainer =new MockServerContainer("5.10.0");
...
//        ResponseEntity<FallbackResponse> r = template.exchange(mockServerContainer.getEndpoint()+"/1", HttpMethod.GET, null, FallbackResponse.class, generatedPathValue);
...
//        int generatedPathValue = 1 + (testPathSelector++ % 2);
//        ResponseEntity<FallbackResponse> r = template.exchange(mockServerContainer.getEndpoint()+"/testInternalServiceError/{id}", HttpMethod.GET, null, FallbackResponse.class, generatedPathValue);
//        LOGGER.info("{}. Received: status->{}, payload->{}, call->{}", generatedPathValue, r.getStatusCodeValue(), r.getBody(), generatedPathValue);
//    }
//
//    @AfterClass
